...
const listFaq = [
  ...
  {
    id: 7,
    question: "Berapa harga premi Asuransi Kesehatan untuk umur 20an ?",
    answer:
      "Harga premi asuransi kesehatan berbeda untuk tiap individu, untuk umur 20 biasa mulai dari 500rb-an, untuk detail nya coba konsultasikan langsung dengan input form dibawah ya :)",
  },
  {
    id: 3,
    question: "Adakah paket asuransi untuk sekeluarga?",
    answer: "Ya, ada paket asuransi yang dirancang khusus untuk keluarga.",
  },
  {
    id: 4,
  ...
  },
  {
    id: 6,
    question:
      "Apa itu masa tunggu dalam asuransi kesehatan? / Bisa langsung dipakai ?",
    answer: `Masa tunggu adalah periode sejak polis aktif hingga manfaat bisa digunakan.\n30 hari untuk seluruh jenis penyakit umum, 90 hari untuk penyakit kanker, dan 1 Tahun untuk 18 penyakit khusus termasuk AIDS / HIV. \n
